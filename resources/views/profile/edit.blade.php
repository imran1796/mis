@extends('layouts.app', ['activePage' => 'file', 'title' => 'GLA Admin', 'navName' => 'User Profile', 'activeButton' => 'laravel'])
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('profile.update') }}" autocomplete="off"
                                    ...
                                    <h6 class="text-center heading-small text-muted mb-4">{{ __('User information') }}</h6>
                                    ...
                                    <div class="">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }} mb-3">
                                            <label class="form-control form-control-sm-label" for="input-name">
                                                <i class="w3-xxlarge fa fa-user"></i>{{ __('Name') }}
                                            </label>
                                            <input type="text" name="name" id="input-name" class="form-control form-control-sm{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Name') }}" value="{{ old('name', auth()->user()->name) }}" required autofocus>

                                            @include('alerts.feedback', ['field' => 'name'])
                                        </div>
                                        <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                            <label class="form-control form-control-sm-label" for="input-email"><i class="w3-xxlarge fa fa-envelope-o"></i>{{ __('Email') }}</label>
                                ...
                                <form method="post" action="{{ route('profile.password') }}">
                                    ...
                                    <h6 class=" text-center heading-small text-muted mb-4">{{ __('Password') }}</h6>

                                    @include('alerts.success', ['key' => 'password_status'])
                                    @include('alerts.error_self_update', ['key' => 'not_allow_password'])

                                    <div class="">
                                        <div class="form-group{{ $errors->has('old_password') ? ' has-danger' : '' }} mb-3">
                                            <label class="form-control form-control-sm-label" for="input-current-password">
                                        ...
                                        <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }} mb-3">
                                            <label class="form-control form-control-sm-label" for="input-password">
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="form-control form-control-sm-label" for="input-password-confirmation">
                    ...
                    <div class="col-md-4">
                        <div class="card card-user">
                            ...
                            <div class="card-body">
                                <div class="author">
                                    <a href="#">
                                        <img class="avatar border-gray" src="{{ asset('light-bootstrap/img/faces/face-0.jpg') }}" alt="...">
