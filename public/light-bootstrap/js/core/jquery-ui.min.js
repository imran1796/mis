                ...
                w(e, function (a, r) {
                    m.fn[a] ||
                        (m.fn[a] = function (t) {
                            ...
                            return "undefined" === i
                                ? o
                                : ("function" === i && (i = P((t = t.call(this, o)))), null == t && r.empty ? this : ("string" === i && (e = f.exec(t)) && (t = o + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)), (n[r.idx] = t), this[s](n)));
                        });
                });
        }),
        (m.hook = function (t) {
                ...
                if (((s._keyEvent = !0), V.datepicker._datepickerShowing))
                    switch (t.keyCode) {
                        ...
                        case 37:
                            ...
                            break;
                        case 38:
                             V.datepicker._adjustDate(t.target, -7, "D"), (n = t.ctrlKey || t.metaKey);
                            break;
                        case 39:
                            V.datepicker._adjustDate(t.target, o ? -1 : 1, "D"),
                                (n = t.ctrlKey || t.metaKey),
